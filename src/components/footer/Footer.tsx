...
const Footer = () => {
  return (
    <div style={{backgroundColor: '#e4e4e4', padding:'64px 32px'}}>
        <div className={footer.mainFooter}>
            <ul className={footer.singleFooter}>
                <p>SHOP</p>
                <li>Ladies</li>
                <li>Men</li>
                <li>Baby</li>
            ...
            <ul className={footer.singleFooter}>
                <p>CORPORATE INFO</p>
                <li>Career at H&M group</li>
                <li>About at H&M group</li>
                <li>Sustainability</li>
                <li>Press</li>
                <li>Investor relations</li>
                <li>Corporate goverance</li>
            </ul>
            <ul className={footer.singleFooter}>
                <p>HELP</p>
        ...
        <div style={{fontSize: '.8125rem', width: '676px', margin: '0 auto', textAlign: 'center'}}>
        <p style={{margin: '30px 0'}}>The content of this site is copyright-protected and is the property of H & M Hennes & Mauritz AB. H&M’s business concept is to offer fashion and quality at the best price in a sustainable way. H&M has since it was founded in 1947 grown into one of the world's leading fashion companies.</p>
        <svg viewBox='0 0 370 244' width='35px'>
